...
# You can then fit a logistic regression model to this simulated data
# to see if you recover the original coefficients:
# simulated_model <- glm(y ~ x1 + x2, family = binomial(link = "logit"), data = sim_data)
